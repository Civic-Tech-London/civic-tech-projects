    ...
    return(
        <Container className="p-5">
            ...
            <Row className="text-start">
                ...
                <Col xs={12} lg={6}>
                    <Profile name="Raghul Ram" image="/img/blank-profile.png" shapeNum = "4" blurb = "Est autem assumenda quas et ex in illum. Provident ipsa voluptate ducimus tempore mollitia animi dolorem. Quas corrupti quia dolorem eos est. Blanditiis libero maxime qui est."/>
                </Col>
                <Col xs={12} lg={6}>
